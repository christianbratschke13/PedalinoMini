  ...
  for(;;) {
    ...
    switch (firmwareUpdate) {
      ...
      case PED_UPDATE_CLOUD:
        //set_clock();
        url = F("https://raw.githubusercontent.com/christianbratschke13/PedalinoMini/master/data/css/bootstrap.min.css.gz");
        get_file_from_cloud(url, "/css/bootstrap.min.css.gz");
        url = F("https://raw.githubusercontent.com/christianbratschke13/PedalinoMini/master/data/js/bootstrap.bundle.min.js.gz");
        get_file_from_cloud(url, "/js/bootstrap.bundle.min.js.gz");
        url = F("https://raw.githubusercontent.com/christianbratschke13/PedalinoMini/master/data/schema.json");
